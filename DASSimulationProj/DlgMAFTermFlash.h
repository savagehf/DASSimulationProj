...
class CDlgMAFTermFlash : public CDialog
{
	DECLARE_DYNAMIC(CDlgMAFTermFlash)

public:
	CDlgMAFTermFlash(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgMAFTermFlash();

// Dialog Data
	enum { IDD = IDD_DLG_MAF_TERMINATION };
...
public:
	...
	//CTime m_timeBegin;
	//CTime m_timePause;
	//UINT  m_nFlashTotalTime;
	afx_msg void OnBnClickedBtnPauseMafFlash();
};
