...
class CDlgMARTermFlash : public CDialog
{
	DECLARE_DYNAMIC(CDlgMARTermFlash)

public:
	CDlgMARTermFlash(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgMARTermFlash();

// Dialog Data
	enum { IDD = IDD_DLG_MAR_TERMINATION };
...
public:
	BOOL m_bPause;
	afx_msg void OnBnClickedBtnPauseMarFlash();
};
