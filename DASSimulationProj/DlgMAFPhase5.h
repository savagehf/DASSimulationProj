...
class CDlgMAFPhase5 : public CDialog
{
	DECLARE_DYNAMIC(CDlgMAFPhase5)

public:
	CDlgMAFPhase5(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgMAFPhase5();

// Dialog Data
	enum { IDD = IDD_DLG_MAF_PHASE_5 };
