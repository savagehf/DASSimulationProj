...
class CDlgMAFPhase4 : public CDialog
{
	DECLARE_DYNAMIC(CDlgMAFPhase4)

public:
	CDlgMAFPhase4(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgMAFPhase4();

// Dialog Data
	enum { IDD = IDD_DLG_MAF_PHASE_4 };
