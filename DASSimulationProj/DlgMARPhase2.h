...
class CDlgMARPhase2 : public CDialog
{
	DECLARE_DYNAMIC(CDlgMARPhase2)

public:
	CDlgMARPhase2(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgMARPhase2();

// Dialog Data
	enum { IDD = IDD_DLG_MAR_PHASE_2 };
