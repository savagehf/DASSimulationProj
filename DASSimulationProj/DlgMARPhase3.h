...
class CDlgMARPhase3 : public CDialog
{
	DECLARE_DYNAMIC(CDlgMARPhase3)

public:
	CDlgMARPhase3(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgMARPhase3();

// Dialog Data
	enum { IDD = IDD_DLG_MAR_PHASE_3 };
	...
	void SetStartGapTime(UINT nGapTime)
	{
		m_nTaskStartGap = nGapTime;
	}
...
public:
	BOOL m_bPause;
	afx_msg void OnBnClickedBtnMar3PauseFlash();
};
